...
\lstdefinelanguage{betterHTML}{
	language=html,
    alsoletter={<>=-},
    otherkeywords={<html>, <head>, <title>, </title>, <meta, />, </head>, <body>,
...
\emph{"Quello che voglio è essere padrone del mio destino, non di quello degli altri." \break --- Long John Silver} \vspace{\stretch{2}}\null
\end{flushright}
